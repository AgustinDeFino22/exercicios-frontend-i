...
function App() {
  return (
    <>
      ...
      <span>
        .Crie um componente chamado 'NumerosPares' que aceita uma prop chamada
      ...
      <Calculadora num1={20} num2={10} operacao="subtracao" />
      <Calculadora num1={5} num2={4} operacao="multiplicacao" />
      <Calculadora num1={20} num2={4} operacao="divisao" />
      <hr />
      <span>
      ...
      <TamanhoTexto texto="Exercícios" />
      <hr />
      <span>
        .Crie um componente chamado 'NomesOrdenados' que aceita uma prop
